...
export type AlertDialogType = typeof AlertDialog & {
...
;(AlertDialog as AlertDialogType).Trigger = AlertDialogTrigger
...
;(AlertDialog as AlertDialogType).Content = AlertDialogContent

const AlertDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col space-y-2 text-center sm:text-left', className)} {...props} />
)
AlertDialogHeader.displayName = 'AlertDialogHeader'
;(AlertDialog as AlertDialogType).Header = AlertDialogHeader
...
;(AlertDialog as AlertDialogType).Footer = AlertDialogFooter
...
;(AlertDialog as AlertDialogType).Title = AlertDialogTitle
...
;(AlertDialog as AlertDialogType).Description = AlertDialogDescription
...
;(AlertDialog as AlertDialogType).Action = AlertDialogAction
...
;(AlertDialog as AlertDialogType).Cancel = AlertDialogCancel

export default AlertDialog as AlertDialogType
