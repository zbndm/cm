...
;(Dialog as DialogType).Trigger = DialogTrigger
...
;(Dialog as DialogType).Content = DialogContent

const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col space-y-2 text-center sm:text-left', className)} {...props} />
)
DialogHeader.displayName = 'DialogHeader'
;(Dialog as DialogType).Header = DialogHeader
...
;(Dialog as DialogType).Footer = DialogFooter
...
;(Dialog as DialogType).Title = DialogTitle
...
;(Dialog as DialogType).Description = DialogDescription
